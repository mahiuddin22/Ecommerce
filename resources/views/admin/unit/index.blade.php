                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    @foreach($units as $key=>$unit)
                        <tr style="box-shadow: 2px 2px 2px #CCCCCC;">
                            ...
                            <td style="border-bottom: 1px solid #c4c4c4;">{{$unit->name}}</td>
                            <td style="border-bottom: 1px solid #c4c4c4;"
                                class="center">{!! $unit->descriptions !!}</td>
                            ...
                            <td style="border-bottom: 1px solid #c4c4c4;" class="center">
                                @if($unit->status == 1)
                                    <a class="btn btn-danger" href="{{route('unit.status',$unit->id)}}">
                                        <i class="halflings-icon white eye-close"></i>
                                    </a>
                                @else
                                    <a class="btn btn-success" href="{{route('unit.status',$unit->id)}}">
